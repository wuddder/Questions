...
var UserStudy1 = function(experiment) {
	...
	this.nextSentence = function() {
		this.nextSentenceNum = (this.nextSentenceNum + 1) % 13;
	}
	this.displayOnTop = function() {
		this.experiment.hideCharacter();
		this.experiment.showCharacter(this.questionSet[this.nextSentenceNum], 90, 6, 1);
	}
	this.displayOnRight = function() {
		this.experiment.hideCharacter();
		var string = this.questionSet[this.nextSentenceNum];
		string = string.split(" ");
		console.log(string);
